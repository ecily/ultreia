let User,jwt;_ba5‍.x([["register",()=>register],["login",()=>login]]);_ba5‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_ba5‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);


       const register = async (req, res) => {
    _ba5‍.g.console.log(req.body)
    ...
    try {
        ...
        user.comparePassword(password, (err, match)=> {
            _ba5‍.g.console.log('COMPARE PASSWORD LOGIN ERROR', err)
        ...
        _ba5‍.g.console.log('auth.js backend - error', err)
