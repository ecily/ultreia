let User,jwt;_1b5‍.x([["register",()=>register],["login",()=>login]]);_1b5‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_1b5‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);


       const register = async (req, res) => {
    _1b5‍.g.console.log(req.body)
    ...
    try {
        ...
        user.comparePassword(password, (err, match)=> {
            _1b5‍.g.console.log('COMPARE PASSWORD LOGIN ERROR', err)
        ...
        _1b5‍.g.console.log('auth.js backend - error', err)
