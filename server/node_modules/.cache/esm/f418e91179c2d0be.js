let User,jwt;_79c‍.x([["register",()=>register],["login",()=>login]]);_79c‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_79c‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);


       const register = async (req, res) => {
    _79c‍.g.console.log(req.body)
    ...
    try {
        ...
        user.comparePassword(password, (err, match)=> {
            _79c‍.g.console.log('COMPARE PASSWORD LOGIN ERROR', err)
        ...
        _79c‍.g.console.log('auth.js backend - error', err)
