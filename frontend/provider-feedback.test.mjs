...
describe('provider feedback component', () => {
  it('renders all supported feedback states and safe technical diagnostics', () => {
    ...
    const html = component.component('profile', { state: 'success', message: 'Anbieterdaten gespeichert.', diagnostic: { method: 'PUT /api/provider/profile', httpStatus: 200, scope: 'local_test', phase: 'cloudinary_upload', providerStatus: 'pending', cloudinary: 'uploaded' } }, true);
    ...
    assert.match(html, /phase=cloudinary_upload/);
